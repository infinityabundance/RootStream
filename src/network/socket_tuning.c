...
int socket_tuning_set_tcp_congestion_control(socket_tuning_t *tuning, int socket,
    ...
    if (setsockopt(socket, IPPROTO_TCP, TCP_CONGESTION, cc_name, strlen(cc_name)) < 0) {
        return -1;
    }
#endif
