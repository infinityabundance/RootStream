...
int loss_recovery_encode_fec_group(loss_recovery_t *recovery, const uint8_t **data_packets,
                                   size_t packet_size, uint8_t packet_count,
...
int loss_recovery_decode_fec_group(loss_recovery_t *recovery, const uint8_t **received_packets,
                                   const bool *packet_present, uint8_t packet_count,
                                   size_t packet_size, uint8_t *recovered_packet) {
...
int loss_recovery_update_strategy(loss_recovery_t *recovery, float packet_loss_percent) {
    if (!recovery) {
        return -1;
    }
