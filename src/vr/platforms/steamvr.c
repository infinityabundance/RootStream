...
static VRPlatformCapabilities steamvr_get_capabilities(VRPlatformBase *platform) {
    ...
    VRPlatformCapabilities caps = {.supportsHandTracking = true,  // Valve Index controllers
...
// VTable for SteamVR
static VRPlatformVTable steamvr_vtable = {.init = steamvr_init,
...
int steamvr_get_chaperone_bounds(SteamVRPlatform *platform, XrVector3f *bounds, uint32_t maxBounds,
                                 uint32_t *boundCount) {
