...
static VRPlatformCapabilities meta_quest_get_capabilities(VRPlatformBase *platform) {
    ...
    VRPlatformCapabilities caps = {.supportsHandTracking = true,
...
static VRPlatformVTable meta_quest_vtable = {.init = meta_quest_init,
...
int meta_quest_get_guardian_bounds(MetaQuestPlatform *platform, XrVector3f *bounds,
                                   uint32_t maxBounds, uint32_t *boundCount) {
