...
uint32_t spatial_audio_create_source(SpatialAudioEngine *engine, const XrVector3f *position,
                                     float radius);
int spatial_audio_update_source_position(SpatialAudioEngine *engine, uint32_t sourceId,
                                         const XrVector3f *position);
int spatial_audio_set_source_volume(SpatialAudioEngine *engine, uint32_t sourceId, float volume);
...
int spatial_audio_apply_hrtf(SpatialAudioEngine *engine, uint32_t sourceId,
                             const uint8_t *audioData, size_t dataSize, uint8_t *processedData);
...
int spatial_audio_update_listener(SpatialAudioEngine *engine, const XrVector3f *position,
