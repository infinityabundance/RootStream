 ...
 */
static int extract_json_string(const char *json, size_t json_len, const char *key, char *value,
                               size_t value_size) {
...
// Host endpoints
int api_route_get_host_info(const http_request_t *req, char **response_body, size_t *response_size,
                            char **content_type) {
    ...
    snprintf(json, sizeof(json),
             ...
             "\"is_streaming\": false"
             "}",
             hostname, (unsigned long)time(NULL));

    return api_send_json_response(response_body, response_size, content_type, json);
}

int api_route_post_host_start(const http_request_t *req, char **response_body,
...
// Metrics endpoints
int api_route_get_metrics_current(const http_request_t *req, char **response_body,
                                  size_t *response_size, char **content_type) {
    (void)req;
...
int api_route_get_metrics_history(const http_request_t *req, char **response_body,
                                  size_t *response_size, char **content_type) {
    (void)req;

    // Return mock history (last 10 samples)
    char json[4096] =
        "{\"fps_history\": [60,59,60,61,60,59,60,60,61,60],"
...
// Peer endpoints
int api_route_get_peers(const http_request_t *req, char **response_body, size_t *response_size,
                        char **content_type) {
    (void)req;
...
int api_route_post_stream_record(const http_request_t *req, char **response_body,
                                 size_t *response_size, char **content_type) {
    (void)req;
...
int api_route_post_stream_stop_record(const http_request_t *req, char **response_body,
                                      size_t *response_size, char **content_type) {
    (void)req;
...
// Settings endpoints
int api_route_get_settings_video(const http_request_t *req, char **response_body,
                                 size_t *response_size, char **content_type) {
    (void)req;
...
int api_route_put_settings_video(const http_request_t *req, char **response_body,
                                 size_t *response_size, char **content_type) {
    (void)req;
...
int api_route_get_settings_audio(const http_request_t *req, char **response_body,
                                 size_t *response_size, char **content_type) {
    (void)req;
...
int api_route_put_settings_audio(const http_request_t *req, char **response_body,
                                 size_t *response_size, char **content_type) {
    (void)req;
...
int api_route_get_settings_network(const http_request_t *req, char **response_body,
                                   size_t *response_size, char **content_type) {
    (void)req;
...
int api_route_put_settings_network(const http_request_t *req, char **response_body,
                                   size_t *response_size, char **content_type) {
    (void)req;
...
int api_route_post_auth_login(const http_request_t *req, char **response_body,
                              size_t *response_size, char **content_type) {
    ...
    if (extract_json_string(req->body_data, req->body_size, "username", username,
                            sizeof(username)) != 0 ||
        extract_json_string(req->body_data, req->body_size, "password", password,
                            sizeof(password)) != 0) {
        char error_json[] =
            "{\"success\": false, \"error\": \"Invalid JSON format or missing credentials\"}";
        return api_send_json_response(response_body, response_size, content_type, error_json);
    }
    ...
    user_role_t role;
    if (auth_manager_verify_token(auth, token, verify_username, sizeof(verify_username), &role) !=
        0) {
...
int api_route_post_auth_logout(const http_request_t *req, char **response_body,
                               size_t *response_size, char **content_type) {
    auth_manager_t *auth = get_auth_manager();
    if (!auth) {
        char error_json[] =
...
int api_route_get_auth_verify(const http_request_t *req, char **response_body,
                              size_t *response_size, char **content_type) {
    auth_manager_t *auth = get_auth_manager();
    if (!auth) {
        char error_json[] =
            "{\"valid\": false, \"error\": \"Authentication system not initialized\"}";
        return api_send_json_response(response_body, response_size, content_type, error_json);
    }
