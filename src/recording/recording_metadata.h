 ...
 * @return            0 on success, -1 on error
 */
int recording_metadata_add_chapter(recording_metadata_t *metadata, uint64_t timestamp_us,
 ...
 */
int recording_metadata_add_audio_track(recording_metadata_t *metadata, const char *name,
 ...
 * @return             0 on success, -1 on error
 */
int recording_metadata_set_game_info(recording_metadata_t *metadata, const char *game_name,
 ...
 * @return            0 on success, -1 on error
 */
int recording_metadata_set_player_info(recording_metadata_t *metadata, const char *player_name);
 ...
 * @return          0 on success, -1 on error
 */
int recording_metadata_add_tags(recording_metadata_t *metadata, const char *tags);
 ...
 * @return          0 on success, -1 on error
 */
int recording_metadata_write_to_mp4(const recording_metadata_t *metadata, const char *filename);
 ...
 * @return          0 on success, -1 on error
 */
int recording_metadata_write_to_mkv(const recording_metadata_t *metadata, const char *filename);
