 ...
 */
int replay_buffer_add_video_frame(replay_buffer_t *buffer, const uint8_t *frame_data, size_t size,
 ...
 * @return             0 on success, -1 on error
 */
int replay_buffer_add_audio_chunk(replay_buffer_t *buffer, const float *samples,
                                  size_t sample_count, uint32_t sample_rate, uint8_t channels,
                                  uint64_t timestamp_us);
 ...
 * @return              0 on success, -1 on error
 */
int replay_buffer_save(replay_buffer_t *buffer, const char *filename, uint32_t duration_sec,
 ...
 * @return                 0 on success, -1 on error
 */
int replay_buffer_get_stats(replay_buffer_t *buffer, uint32_t *video_frames_out,
                            uint32_t *audio_chunks_out, uint32_t *memory_used_mb,
