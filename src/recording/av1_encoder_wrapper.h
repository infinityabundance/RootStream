 ...
 */
int av1_encoder_init(av1_encoder_t *encoder, uint32_t width, uint32_t height, uint32_t fps,
                     uint32_t bitrate_kbps, int cpu_used, int crf);
 ...
 * @return              0 on success, -1 on error
 */
int av1_encoder_encode_frame(av1_encoder_t *encoder, const uint8_t *frame_data,
