...
fc_stats_t *fc_stats_create(void) { return calloc(1, sizeof(fc_stats_t)); }
void        fc_stats_destroy(fc_stats_t *st) { free(st); }
void        fc_stats_reset(fc_stats_t *st) { if (st) memset(st, 0, sizeof(*st)); }
